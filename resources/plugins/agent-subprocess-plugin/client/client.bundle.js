...
var AgentUtil = __webpack_require__(/*! ../util/AgentUtil */ "./client/util/AgentUtil.js");
...
AgentCreateAppendProvider.prototype.getPopupMenuEntries = function(element) {
  ...
  var isCreate = !element || !element.parent;
  ...
  return {
    'create-agentic-subprocess': {
      ...
      action: {
        ...
        click: isCreate
          ? function(event) { self._createStart(event); }
          : function() { self._appendClick(element); },

        // Drag always starts manual placement; include source hint when appending.
        dragstart: isCreate
          ? function(event) { self._createStart(event); }
          : function(event) { self._createStart(event, element); }
      }
    }
  };
};
...
function AgentPropertiesProvider(eventBus, modeling, bpmnFactory) {
  ...
  eventBus.on('propertiesPanel.updated', function(event) {
...
function injectCustomPanel(element, modeling) {
  ...
  var container = document.querySelector('.bio-properties-panel-container');
...
AgentReplaceMenuProvider.prototype.getPopupMenuEntries = function(element) {
  ...
  var isSubProcess = element.type === 'bpmn:SubProcess';
  var isAdHoc = element.type === 'bpmn:AdHocSubProcess';
  ...
  return {
    'replace-with-agentic-subprocess': {
      ...
      action: function() {
        ...
        setTimeout(function() {
          addAgentOverlay(target, overlays);
        }, 100);
      }
    }
  };
...
var AgentCreateAppendProvider = __webpack_require__(/*! ./provider/AgentCreateAppendProvider */ "./client/provider/AgentCreateAppendProvider.js");
var AgentReplaceMenuProvider = __webpack_require__(/*! ./provider/AgentReplaceMenuProvider */ "./client/provider/AgentReplaceMenuProvider.js");
var AgentPropertiesProvider = __webpack_require__(/*! ./provider/AgentPropertiesProvider */ "./client/provider/AgentPropertiesProvider.js");
var AgentOverlayProvider = __webpack_require__(/*! ./provider/AgentOverlayProvider */ "./client/provider/AgentOverlayProvider.js");
